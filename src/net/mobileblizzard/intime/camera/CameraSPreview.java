...
public class CameraSPreview extends SurfaceView implements SurfaceHolder.Callback {
	...
	public CameraSPreview(Context context, Camera camera) {
		super(context);					
