...
public class BlackPopupWrapper {
	...
	public void initChooser(MainActivity c, FrameLayout mainUI, FrameLayout settingsChooserUIBlack, LinearLayout contentUI, FrameLayout closeChooserUI){
		this.mainContext = c;
		this.mainUI = mainUI;
